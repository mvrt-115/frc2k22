...
public class Robot extends TimedRobot {
  ...
  TalonSRX stor = new TalonSRX(39);
  TalonSRX rol = new TalonSRX(21);
  ...
  public void robotInit() {
    ...
    shot.configFactoryDefault();
    shot.setInverted(true);
  ...
  public void autonomousPeriodic() {
    ...
    rol.set(ControlMode.PercentOutput, 0.6);
    shot.set(ControlMode.PercentOutput, 0.3);
  }
