...
public final class Constants {
    ...
    public static class Storage{
         public static final int kBreakBeamPort0 = 1; // change value later
        public static final int kBreakBeamPort1 = 0; // change value later
        public static final int kMotor1ID = 20; // change value leftMaster
        public static final double kMotorSpeed = 0.3; // change value later
    }
}
